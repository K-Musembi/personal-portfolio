...
const AWSProjects = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-16 bg-primary"> {/* Consistent padding with Skills.jsx */}
          ...
          >
            ...
            <div className="absolute left-3 right-3 md:left-5 md:right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
              <button
                ...
                aria-label={`Go to previous AWS project slide`}
              >
                ❮
              </button>
              <button
                ...
                className="btn btn-circle btn-primary text-neutral-content hover:bg-neutral-focus"
                aria-label={`Go to next AWS project slide`}
              >
                ❯
              </button>
            </div>
