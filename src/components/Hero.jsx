            ...
            <div className="hero-content text-neutral-content text-center">
                <div className="max-w-xs sm:max-w-md px-4">
                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-3 md:gap-12 mt-6 md:mt-8">
                        <button onClick={handleAboutClick} className="btn btn-primary btn-md md:btn-lg rounded-full max-w-xs mx-auto md:max-w-none">About Me</button>
                        <a href="/Kevin_Musembi_Resume.pdf" download className="btn btn-base-100 btn-md md:btn-lg text-primary rounded-full max-w-xs mx-auto md:max-w-none">Download Resume</a>
                    </div>
                </div>
            </div>
        </div>
